from sqlalchemy import create_engine, MetaData, Table, Column, Integer, String, insert, select, bindparam, delete
...
# )
#
# with engine.connect() as conn:  # TODO: станешь умней посмотри почему не вставляются данные (в док-ции так)
#     conn.execute(
...
#     conn.commit()
#
# select_stmt = select(user_accounts)
# with engine.connect() as conn:
